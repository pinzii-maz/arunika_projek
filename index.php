...
<body class="bg-gray-100">
    ...
    <!-- Header Section -->
    <header class="relative bg-cover bg-center rounded-b-3xl overflow-hidden" style="background-image: url('assets/img/wp9288747.jpg'); height: 600px;">
        <div class="absolute inset-0 bg-black opacity-60"></div>

        <!-- Logo -->
        <div class="absolute top-8 left-8 z-10">
            <div class="bg-white text-gray-900 rounded-xl p-2 flex items-center justify-center w-14 h-14 font-bold text-3xl">
                L
            </div>
        </div>

        <!-- Navigasi di pojok kanan atas -->
        <div class="absolute top-8 right-8 flex flex-col items-center z-30">
            <!-- Overlay dengan latar belakang transparan -->
            <div class="absolute inset-0 bg-gray-200 opacity-60 rounded-3xl max-w-3xl w-full h-16"></div>

            <!-- Kontainer untuk menempatkan navigasi di tengah -->
            <div class="relative flex mt-1 mx-2 items-center">
                <a href="index.php" class="bg-white rounded-full m-2 py-1 px-4 text-black font-medium hover:text-gray-300">Home</a>
                <a href="#" class="bg-white rounded-full m-2 py-1 px-4 text-black font-medium hover:text-gray-300">Contact</a>
                <a href="#" class="bg-white rounded-full m-2 py-1 px-4 text-black font-medium hover:text-gray-300">Pusat bantuan</a>

                <!-- Ikon profil dengan dropdown -->
                <div class="relative" x-data="{ open: false }">
                    <!-- Tombol untuk membuka/menutup dropdown -->
                    <button class="bg-white p-1 rounded-xl m-2 focus:outline-none" @click="open = !open">
                    ...
                    <div
                        ...
                        class="absolute bg-white w-32 right-0 mt-2 rounded-lg shadow-lg">
                        <a href="php/login.php" class="block px-4 py-2 text-black rounded-lg hover:bg-gray-100">Sign In</a>
                        <a href="php/register.php" class="block px-4 py-2 text-black rounded-lg hover:bg-gray-100">Sign Up</a>
                    </div>
                </div>
            </div>
        ...
        <div class="relative z-10 h-full flex flex-col justify-center text-white">
            <h1 class="text-8xl font-bold mb-4">
                <span class="flex ml-16 mb-4">Ruang Ujian</span>
                <span class="ml-96">dan Kajian</span>
            </h1>

            <!-- Kontainer untuk List Acara -->
            <div class="relative flex flex-col">
                <!-- Overlay hanya untuk List Acara -->
                <div class="absolute bg-gray-200 opacity-50 rounded-3xl w-36 h-14 left-36"></div>

                <!-- Tombol List Acara di tengah overlay -->
                <button class="absolute z-20 flex items-center px-4 py-2 text-black text-xl rounded-3xl left-36 top-1">
                    About Us
    ...
    <!-- Section List Acara -->
    <section class="flex flex-col justify-center items-center container mx-auto px-4 py-8">
        <h2 class="text-2xl font-semibold mb-4">LIST ACARA</h2>
        <div class="w-1/2">
            <a href="">
                <div class="flex justify-between bg-white h-40 rounded-lg mb-4 shadow-md">
                    <div class="flex flex-col items-start justify-center">
                        <p class="ml-8 mb-2 italic">Event from Hima TI</p>
                        <h1 class="text-4xl font-bold ml-8 mb-2">IT FEST 2024</h1>
                        <p class="ml-8 flex">Tanggal Pelaksanaan: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 ml-2 mr-1 mt-1">
    ...
    <section class="container mx-au to px-4 py-16">
        <div class="flex">
            <div class="w-[600px] ml-14 bg-gradient-to-br from-gray-200 to-gray-300 p-8 rounded-lg shadow-lg">
                <!-- Kontainer pertama dengan latar belakang abu-abu -->
                <h2 class="text-2xl font-semibold mb-4">Latar belakang
                    <span class="bg-white px-4 py-1 rounded-2xl text-2xl">kami</span>
                </h2>

                <!-- Kontainer kedua dengan latar belakang putih -->
                <div class="bg-white p-8 rounded-lg shadow-lg h-[600px]">
                    <p class="text-black">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint vel facilis, impedit veniam provident voluptatibus itaque expedita beatae similique neque minima iusto sed quidem natus repudiandae voluptate accusantium ratione quos vitae omnis quasi quo. Voluptatum, ex? Soluta molestias eos accusamus provident veritatis perspiciatis voluptatem culpa alias tenetur similique? Aut adipisci, quas earum esse labore sed laudantium. Sint dolorum fugit officiis suscipit! Provident hic tempora recusandae necessitatibus repellat a suscipit corporis eum architecto odit! Corrupti aut et optio esse id fugiat, accusamus totam porro odio error iste, itaque aperiam quos reiciendis ipsam doloremque, eaque voluptates. Magni sed reiciendis quisquam rerum veritatis?
                    </p>
                </div>
            </div>
            ...
            <div class="flex justify-center my-auto">
                <div class="relative flex flex-col">
                    <!-- Gambar Pertama, dinaikkan -->
                    <div class="bg-white p-6 rounded-lg shadow-lg w-[500px] ml-36 translate-y-[-200px] rotate-[-10deg]">
                        <img src="assets/img/wp9288747.jpg" alt="Dokumentasi 1" class="w-full h-full rounded-lg">
                    </div>
                    <!-- Gambar Kedua, diturunkan -->
                    <div class="absolute top-0 ml-72 ">
                        <div class="bg-white p-6 rounded-lg shadow-lg w-[500px]">
                            <img src="assets/img/wp9288747.jpg" alt="Dokumentasi 2" class="w-full h-full rounded-lg">
                        </div>
                    </div>
                    <div class="absolute top-0 ml-16 translate-y-[170px] rotate-[10deg]">
                        <div class="bg-white p-6 rounded-lg shadow-lg w-[500px]">
                            <img src="assets/img/wp9288747.jpg" alt="Dokumentasi 2" class="w-full h-full rounded-lg">
                        </div>
                    </div>
    ...
    <footer class="bg-white">
        <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    <div class="flex justify-center text-black sm:justify-start">
            ...
            <div class="mt-12 border-t border-gray-100 pt-6">
                <div class="text-center sm:flex sm:justify-between sm:text-left">
                    <p class="text-sm text-gray-500">
                        ...
                        <a
                            class="inline-block text-black underline transition hover:text-teal-600/75"
                            href="#">
                            Terms & Conditions
                        </a>
                    ...
                    <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 Rujak X Dev</p>
                </div>
            </div>
        </div>
    </footer>
